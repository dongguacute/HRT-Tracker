    ...
    <div className="p-8 max-w-4xl mx-auto space-y-8">
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900">检查记录 (校准)</h2>
        ...
        <div className={cn(
          ...
          (showAddForm || editingId) ? "bg-blue-50" : "bg-[#E6F0F6]"
        )}>
      ...
      <AnimatePresence>
        {(showAddForm || editingId) && (
          <motion.div 
            ...
            className="bg-[#F2F7FA] rounded-[32px] p-8 shadow-sm relative overflow-hidden"
          >
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-2xl p-4 flex gap-3">
                ...
                <div className="space-y-1">
                  <h4 className="font-bold text-gray-900 text-sm">为什么要添加检查记录？</h4>
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-500">抽血时间</label>
                        ...
                        >
                          <div className="flex flex-col gap-6">
                            ...
                            <div className="flex gap-4 mt-2">
                              ...
                              <button
                                onClick={() => setIsCalendarOpen(false)}
                                className="flex-1 py-4 bg-blue-500 text-white rounded-[24px] font-bold hover:bg-blue-600 transition-colors flex items-center justify-center"
                              >
                                确定
                              </button>
                            </div>
              ...
              {/* Value Input */}
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-500">雌二醇 (E2) 数值</label>
                <div className="flex gap-3">
                  <div className="relative flex-1">
                    <input 
                      ...
                      className="w-full bg-white rounded-2xl p-6 text-2xl font-bold text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all"
                      placeholder="0.0"
                    />
                  </div>
                  <div className="relative w-32">
                    <button 
                      ...
                      className="w-full h-full bg-white rounded-2xl p-4 flex items-center justify-between border border-transparent hover:border-gray-200 transition-all text-left"
                    >
                      <span className="font-bold text-gray-900">{selectedUnit.label}</span>
                      <ChevronDown className={cn("w-4 h-4 text-gray-400 transition-transform", isUnitOpen && "rotate-180")} />
                    </button>
                        ...
                        >
                          {UNITS.map((u) => (
                            ...
                            >
                              ...
                              {selectedUnit.id === u.id && <Check className="w-4 h-4 text-blue-500" />}
                            </button>
                          ))}
                        </motion.div>
                      )}
              ...
              <div className="flex items-center justify-end pt-4">
                <button 
                  onClick={handleSave}
                  className="px-8 py-4 bg-blue-500 text-white rounded-2xl font-bold flex items-center gap-2 hover:bg-blue-600 transition-all shadow-lg shadow-blue-500/20"
                >
        ...
        <div className="space-y-3">
          {records.length === 0 ? (
            <div className="text-center py-12 bg-gray-50 rounded-[32px] border-2 border-dashed border-gray-200">
              <p className="text-gray-400">暂无检查记录</p>
            </div>
          ) : (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-1">
                        <h4 className="font-bold text-gray-900">雌二醇 (E2)</h4>
                      ...
                      <div className="flex items-center justify-between">
                        <p className="text-lg font-bold text-blue-600">
                          {record.value} <span className="text-sm font-medium text-gray-400">{record.unit}</span>
                        </p>
